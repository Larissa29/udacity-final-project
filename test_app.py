...
class MainTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.database_path = "postgresql://{}:{}@{}/{}".format("postgres", "h.K9!S^NQd}h^W3m<wK3", "localhost:5432",
                                                               self.database_name)
    ...
    def test_401_unauthorized_get_movies(self):
    ...
    def test_403_unauthorized_add_actor(self):
        new_actor = {
            'name': 'Linda Chen',
            'age': 24,
            'gender': 'F',
    ...
    def test_403_unauthorized_modify_movie(self):
        edit_movie = {
            'title': '',
    ...
    def test_403_unauthorized_add_movie(self):
        new_movie = {
            'title': 'To test',
            'release_date': '2017-10-20'
        }
